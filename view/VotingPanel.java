...
public class VotingPanel extends JPanel {
	...
	public VotingPanel(final District district) {
		...
		districtCandidatesList = Utilities.newJList(ClientController
				.getDistrictCandidates(district), new Font("Courier New",
				Font.BOLD, 24));

		add(Utilities.newJLabel(district.getName() + " Candidates", 0, 0,
				layout));
		districtCandidatesScrollPane = Utilities.newJScrollPane(
				districtCandidatesList, 0, 1, 1, 4, layout);
