...
public class Message implements Serializable {
	 ...
	 */
	public Message(byte[] bytes) throws IOException, MessageCorruptException {
		try {
	 ...
	 */
	public static long calculateChecksum(Object data) throws IOException {
		CRC32 crc = new CRC32();
	...
	public String toString() {
		return "[" + senderPort + ", " + method + ", " + type + ", " + data
				+ ", " + checksum + "]";
	}
